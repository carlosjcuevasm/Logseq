...
- ## TODO ITEM
  Pack:: [[WKP-Now Contract]] 
  #work-item
	- ## NAME: [[I-Jobs listings for Video streaming systems]]
	- **Succes looks like**: I was able to find job listings other than within LinkedIn. I was able to confirm and act if there are better places for this role job listings.
	- **Time Est (hrs):**
	- **Notes**:
	- **Disciplines:**
	- **More:**
	  collapsed:: true
		...
		- **Success:**
		- **Sprint:**
- TODO Cosas quehacer puntacana, por tanto presupuesto #recovery