...
- **time-scaled control stack**:
  collapsed:: true
	- Long-term awareness
	- Mid-term intent
	- Short-term commitment
	- Daily execution
- **Backlog** - All items you know about.  Might just be the nodes used as topics too. This is the inventory of nodes.
	- [[Nodes Backlog]]
	...
	- If life is a node graph, use tools sharing that concept
	  collapsed:: true
		...
		- Tips for written documentation
			...
			- Good writing mixes both layers
